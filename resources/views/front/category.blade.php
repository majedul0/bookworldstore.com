    ...
    <div class="container">
        ...
        <div class="pt-6 pb-14">
            ...
            <div class="text-center">
                <button class="bg-black text-white hover:bg-gray-800 px-4 py-2 rounded-lg inline-block mt-8 loadMoreProductBtn">Load More</button>

                <button class="bg-gray-400 text-white hover:bg-gray-500 px-4 py-2 rounded-lg inline-block mt-8 loadMoreProductLoader" style="display: none">
